...
data class Game(
    ...
    private val turkishkeyboardKeys: KeyboardKeys=KeyboardKeys.Turkish()
) {
    val availableKeyboard: KeyboardKeys = keyboardKeys.updateWithGuesses(guesses)
    val turkishavailableKeyboard: KeyboardKeys = turkishkeyboardKeys.updateWithGuesses(guesses)
